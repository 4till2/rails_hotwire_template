...
class RecordsTest < ApplicationSystemTestCase
  ...
  test "should create record" do
    ...
    fill_in "Account", with: @record.account_id
    fill_in "Creator", with: @record.creator_id
    fill_in "Description", with: @record.description
    fill_in "Recordable", with: @record.recordable_id
    fill_in "Subtitle", with: @record.subtitle
